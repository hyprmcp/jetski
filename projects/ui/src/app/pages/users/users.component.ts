...
import { ActionDropdownComponent } from './table/action-dropdown.component';
import {
  TableHeadSelectionComponent,
  TableRowSelectionComponent,
} from './table/selection-column.component';
...
@Component({
  ...
  template: `
    ...
    <div
      class="border-border mt-4 block h-[18rem] w-full overflow-auto rounded-md border"
    >
